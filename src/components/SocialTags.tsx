    ...
    <section>
      ...
      <div className="space-x-3">
        <Button size="icon" variant="outline" asChild>
          <Link href="https://www.linkedin.com/in/zak-hajjaji-m-sc-939920111/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile">
            <svg
              role="img"
        ...
        <Button size="icon" variant="outline" asChild>
          <Link href="mailto:zak.hajjaji@icloud.com" aria-label="Send email">
            <Mail className="h-5 w-5"/>
          </Link>
        </Button>
        <Button size="icon" variant="outline" asChild>
          <Link href="https://github.com/funkmafia" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile">
            <svg
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
