  ...
  return (
    <section id="stats" ref={elementRef as React.RefObject<HTMLElement>} className="py-12 md:py-6 scroll-mt-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        <div className="relative overflow-hidden rounded-sm-2xl border border-border/70 bg-background/60 backdrop-blur p-5 md:p-6">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
            ...
            />
            <div
              className="absolute left-1/2 top-0 h-[30vh] w-[70%] -translate-x-1/2 rounded-sm-full blur-2xl"
              style={{
                background:
            ...
            />
            <div
              className="absolute left-[12%] top-[28%] h-40 w-40 -translate-x-1/2 rounded-sm-full blur-2xl"
              style={{
                background:
            ...
            />
            <div
              className="absolute right-[8%] top-[18%] h-36 w-36 translate-x-1/2 rounded-sm-full blur-2xl"
              style={{
                background:
          ...
          <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {stats.map((s) => (
              <SpotlightCard key={s.label} className="p-5 text-center rounded-sm-xl bg-background/70 border border-border/70 hover:border-primary/50 transition-colors">
